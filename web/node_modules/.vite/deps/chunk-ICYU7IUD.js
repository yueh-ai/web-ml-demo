...
var React5, testOmitPropsOnStringTag, testOmitPropsOnComponent, getDefaultShouldForwardProp, composeShouldForwardProps, isDevelopment4, ILLEGAL_ESCAPE_SEQUENCE_ERROR2, Insertion5, createStyled;
...
function deepClone(source) {
  if (React8.isValidElement(source) || !isPlainObject(source)) {
    return source;
  }
  const output = {};
...
function deepmerge(target, source, options = {
  ...
  if (isPlainObject(target) && isPlainObject(source)) {
    Object.keys(source).forEach((key) => {
      if (React8.isValidElement(source[key])) {
...
var maybeReactUseSyncExternalStore = React10["useSyncExternalStore"];
...
function isMuiElement(element, muiNames) {
  ...
  return React11.isValidElement(element) && muiNames.indexOf(
...
var maybeReactUseId = React12["useId".toString()];
...
function useLazyRef(init, initArg) {
  const ref = React16.useRef(UNINITIALIZED);
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ICYU7IUD.js.map
